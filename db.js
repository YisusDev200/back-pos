...
db.serialize(() => {
    ...
    db.run("CREATE TABLE IF NOT EXISTS product_keys (email TEXT, hardware_id TEXT, rfc TEXT, product_key TEXT, expiration_date DATETIME, PRIMARY KEY (email, hardware_id, rfc))");
});
